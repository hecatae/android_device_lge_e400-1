...
mkdir -p ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/firmware/wlan/volans
...
## HAL
adb pull /system/lib/hw/sensors.default.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib/hw/sensors.default.so
...
## BT
adb pull /system/etc/firmware/wlan/volans/WCN1314_qcom_fw.bin ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/firmware/wlan/volans/

## Wifi
adb pull /system/etc/wifi/WCN1314_qcom_cfg.ini ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/wifi/
adb pull /system/etc/wifi/WCN1314_qcom_wlan_nv.bin ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/wifi/
