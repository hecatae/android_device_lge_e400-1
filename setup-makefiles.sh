...
## HAL
PRODUCT_COPY_FILES += \\
    vendor/__VENDOR__/__DEVICE__/proprietary/lib/hw/sensors.thunderg.so:system/lib/hw/sensors.default.so \\
    vendor/__VENDOR__/__DEVICE__/proprietary/lib/hw/gralloc.thunderg.so:system/lib/hw/gralloc.default.so
...
## WiFi
PRODUCT_COPY_FILES += \\
    vendor/__VENDOR__/__DEVICE__/proprietary/etc/wifi/WCN1314_qcom_cfg.ini:system/etc/wifi/WCN1314_qcom_cfg.ini \\
    vendor/__VENDOR__/__DEVICE__/proprietary/etc/wifi/WCN1314_qcom_wlan_nv.bin:system/etc/wifi/WCN1314_qcom_wlan_nv.bin
EOF
